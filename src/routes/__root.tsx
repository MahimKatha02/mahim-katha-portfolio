...
//       { title: "Mahim Chowdhury Katha | AI, Machine Learning & Web Developer" },
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "preload", as: "image", href: "/profile2.jpg", fetchPriority: "high" },
    ],
  }),
  shellComponent: RootShell,
  component: RootComponent,
...
function RootShell({ children }: { children: ReactNode }) {
  return (
    <html lang="en">
      <head>
        <HeadContent />
        {/* Add inline style for image loading optimization */}
        <style>{`
          img {
